...
param.ms1 = 96.9677/param.scales.mass;
param.mp1 = 1394.8425/param.scales.mass;
param.Isp1 = 267.6/param.scales.time;
% 2nd stage
param.m02 = 347.5605/param.scales.mass;
param.ms2 = 31.6638/param.scales.mass;
param.mp2 = 269.8966/param.scales.mass;
...
init_x(ntot*N+1) = 1.2/param.scales.time; 
init_x(ntot*N+2) = 3/param.scales.time;
init_x(ntot*N+3) = 10/param.scales.time;
...
function [c,ceq] = nonl_con_sep(x,N_1st,N_2nd,x0,param)
    ...
    ind_height_abv = find(state(3,:)>=param.plf_dropalti_ref);
    ...
    ceq(param.nstate*(N-1)+1:param.nstate*N) = ...
        state(:,N_1st+2) - [stg_sep_record.x(end,1:param.nstate-1)';aug_mass_stg_sep];
