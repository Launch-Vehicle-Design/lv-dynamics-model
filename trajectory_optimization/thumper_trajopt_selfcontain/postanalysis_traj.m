...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % POSITION
figure; subplot_size = [2,2]; subplot_ind = 1;
...
scatter(t(ind_max_q),q_imp(ind_max_q),"filled","LineWidth",2,"MarkerFaceColor","b");
scatter(t(ind_max_qalf),q_imp(ind_max_qalf),"filled","LineWidth",2,"MarkerFaceColor","g");
legend("Max Q Time History","Max Q", "Max Q$\alpha$","interpreter","latex");
ylabel("Dynamics Pressure (psi)"); xlabel("Time since Release (s)");
subplot_ind = subplot_ind+1;

subplot(subplot_size(1),subplot_size(2),subplot_ind);
plot(t,qalf_imp,"k","LineWidth",1.2); hold on; grid on
scatter(t(ind_max_q),qalf_imp(ind_max_q),"filled","LineWidth",2,"MarkerFaceColor","b");
scatter(t(ind_max_qalf),qalf_imp(ind_max_qalf),"filled","LineWidth",2,"MarkerFaceColor","g");
