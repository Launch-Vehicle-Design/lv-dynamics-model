...
param.brm.L_N = param.l.plf*param.scales.length; % length of nosecone, m
...
param.brm.X_R = 0; 
param.brm.X_B = param.d.enge1st*param.scales.length; % Distance from nose tip to fin leading edge, m
...
param.rcp_1st = [-rcp_1st/param.scales.length; 0; 0];
param.rcp_2nd = [-rcp_2nd/param.scales.length; 0; 0];
end