function param = sysparam(param,scales)
if ~exist("scales","var")
    scales.length       = 1;
    scales.speed        = 1;
...
param.Isp2 = 377.2/param.scales.time;
param.Isp_acs = 220/param.scales.time;
param.OFratio = 1.275;
...
param.TtoW_1st = 1.6;
param.TtoW_2nd = 0.8;
param.T_acs = 5/param.scales.force;
...
param.release.alti = 40000*0.3048/param.scales.length;
param.release.velo = 250.786/param.scales.speed;

% final condition parameter
param.final_ref.v = 7754.1/param.scales.speed;
param.final_ref.alt = 251460/param.scales.length;
param.final_ref.fpa = 0;
param.final_ref.orb_inc = 100/180*pi;
param.final_ref.plf_dropalti = 140e3/param.scales.length;
